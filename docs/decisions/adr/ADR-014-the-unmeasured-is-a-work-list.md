...
| | count | share |
| --- | --- | ---: |
| **(a) measurable here, just not done** | **134** | 54 % |
...
> that agreement — made it `133`; `D.24`, found while writing the roadmap, made it `134`, and the table above says `134`.** Both states are recorded
...
| **(a) entries remaining** | **66** — ⚠️ **as of that round.** Recounted after round three: **134**, and the recount's unit and tree state are stated above rather than assumed |
