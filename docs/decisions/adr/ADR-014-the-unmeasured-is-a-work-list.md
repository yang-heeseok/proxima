...
| | count | share |
| --- | --- | ---: |
| **(a) measurable here, just not done** | **135** | 55 % |
...
> that agreement — made it `133`; `D.24` and `D.25`, both found while writing the roadmap, made it `135`, and the table above says `135`.** Both states are recorded
...
| **(a) entries remaining** | **66** — ⚠️ **as of that round.** Recounted after round three: **135**, and the recount's unit and tree state are stated above rather than assumed |
